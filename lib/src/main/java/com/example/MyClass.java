...
public class MyClass extends JFrame {
    ...
    public MyClass() {
        ...
        final JButton preMonth = new JButton("pre mon");
        ...
        final JButton nextMonth=new JButton("next mon");
    ...
    private void updateCalendar() {
        ...
        monthLable.setText(""+calendar.get(Calendar.YEAR)+"."+(calendar.get(Calendar.MONTH)+1)+"");
    }
